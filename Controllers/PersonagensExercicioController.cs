...
public class PersonagensExercicioController : ControllerBase
{
    ...
    [HttpGet("GetByNome")]
    public IActionResult GetQualquerCoisa()
    {
        return NotFound();
    }
    ...
    public IActionResult Remove("[Cavaleiros]")
    ...
    class Program
    {
        static void Main()
        {
            ...
            // Exibe o resultado
            Console.WriteLine("Lista Decrescente: " + string.Join(",", decrescente));
    ...
    // Código para retornar BadRequest (ex: status 400 em frameworks HTTP)
